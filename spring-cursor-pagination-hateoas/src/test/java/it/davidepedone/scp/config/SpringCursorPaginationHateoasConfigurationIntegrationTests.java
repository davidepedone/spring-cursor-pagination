...
import it.davidepedone.scp.WebTestUtils;
...
/**
 * Integration test for {@link SpringCursorPaginationHateoasConfiguration}
 *
 * @author Davide Pedone
 */
class SpringCursorPaginationHateoasConfigurationIntegrationTests {
	...
	void registersBasicBeanDefinitions() throws Exception {
		...
		assertThat(names).contains("hateoasCursorPageableResolver", "cursorPageableResolver", "sortResolver");
